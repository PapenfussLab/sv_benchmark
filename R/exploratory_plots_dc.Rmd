...
```{r}
grid.newpage()
first_four <- do.call(cbind, all_id_precision_plot_grobs[1:4])
second_four <- do.call(cbind, all_id_precision_plot_grobs[5:8])
all_eight <- rbind(first_four, second_four)
grid.draw(all_eight)
```
